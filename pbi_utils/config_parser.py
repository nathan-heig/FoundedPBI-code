...
class YAMLConfig(BaseModel):
    ...
    classifier: ClassifierConfig = Field(default_factory=lambda: ClassifierConfig(name="LinearClassifier", params={}))
...
class Config:
    ...
    def __init__(self, yaml_config: YAMLConfig, raw_dict):
        ...
        self.phages_embedding_models, self.compute_phages_embeddings = self._parse_models(yaml_config.phages_embedding_models)
        self.bacteria_embedding_models, self.compute_bacteria_embeddings = self._parse_models(yaml_config.bacteria_embedding_models)
    ...
    def _parse_models(self, models_config: List[ModelConfig]) -> Tuple[List[AbstractModel], List[CACHED_EMBEDDINGS_OPTION]]:
        models = []
        cached_embeddings = []
