...
for strategy in "${strategies[@]}"; do
    ...
    STRATEGY=$strategy OVERLAP="0" python main.py -c model_configs/NT2_env.yaml
done

echo "==============================================================================================================="
echo "========================================NT2_tkpert_concat======================================================"
echo "==============================================================================================================="
TKPERT_MERGING_STRATEGY="concat" OVERLAP="0" python main.py -c model_configs/NT2_tkpert.yaml

echo "==============================================================================================================="
echo "========================================NT2_tkpert_avg========================================================="
echo "==============================================================================================================="
TKPERT_MERGING_STRATEGY="avg" OVERLAP="0" python main.py -c model_configs/NT2_tkpert.yaml